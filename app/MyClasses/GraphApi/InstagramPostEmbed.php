...
class InstagramPostEmbed
{

    private $endpoint;

    public function __construct($accesstoken, $permalink)
    {
        ...
        $this->endpoint = $conf->getEndpoint_base() . 'instagram_oembed';
        ...
        $this->endpoint .= '?' . http_build_query($igParams);
    }
