...
<head>
    ...
    <title>Graph Api Using appsecret_proof</title>
</head>
<body>
<div class="container">
    <div class="row">
        <div class="col-12">
            <h1 class="mt-5">appsecret_proofを使ったセキュアなアクセス方法</h1>
            <p>情報が取れない場合<br>
            ...
            <?php else : ?>
                ...
                <div class="card mt-5">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <strong>設定</strong>マイアプリ>サイドバーの「設定」>「詳細設定」> 「App Secretをオンにする」をオンに設定。<br>
                            これにより全てのエンドポイントへのアクセスは「appsecret_poof」を付加しなければならない。<br>
                            appsecret_proofの生成方法は以下の通り<br>
